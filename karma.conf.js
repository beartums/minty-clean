// Karma configuration
// Generated on Wed Dec 11 2019 23:46:05 GMT+0000 (Coordinated Universal Time)
...
module.exports = function(config) {
  config.set({
    ...
    files: [
      { pattern: 'app/test/*.spec.js', watched: true, served: true, included: true }
      /*parameters:
    ...
    browsers: ['ChromeHeadlessCI' /*'Chrome', 'Firefox','Edge','ChromeCanary','Opera','IE','Safari'*/],
